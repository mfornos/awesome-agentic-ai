...
- **[Akash](https://akash.network/)** *(example of a decentralized cloud platform)* — decentralized cloud platform for deploying and managing containerized applications.
...
This list is released under the **CC BY-SA 4.0**.
